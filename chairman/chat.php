						...
						<div class="col-lg-3 col-md-4 col-sm-12">
							<div class="chat-list bg-light-gray">
								...
								<div class="notification-list chat-notification-list customscroll">
									<ul>
                                        <?php
		                                  $query = mysqli_query($conn,"select * from tblemployees where Department = '$session_depart' and emp_id != '$session_id'") or die(mysqli_error($conn));
							...
							<div class="chat-detail">
								<div class="chat-profile-header clearfix">
									<div class="left">
										<div class="clearfix">
                                            <?php
		                                    $query = mysqli_query($conn,"select * from tblemployees where emp_id='$receiver'") or die(mysqli_error($conn));
		                                    while ($row = mysqli_fetch_array($query)) {
		                                    $id = $row['emp_id'];
		                                    ?>
