<?php
	...
	class PDF extends TCPDF
	{
	    public function Header()
	    {
	    	...
	    	$this->Cell(189, 5, 'Ceylon Petroleum Storage Terminals Limited', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(2);
	    	$this->Cell(189, 3, 'Kollonnawa, Wellampitiya', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(2);
	...
	$pdf->SetAuthor('CPSTL Leave System');
	$pdf->SetTitle('CPSTL Leave System');
	$pdf->SetSubject('');
	$pdf->SetKeywords('');
	...
	$pdf->Output('CPSTL_Leave_System.pdf', 'I');
